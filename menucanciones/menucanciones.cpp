...
MenuCanciones :: MenuCanciones() {
    string canciones[50] = {
        "Under The Influence", "Yours", "I Aint Worried", "Calm Down", "Im Good (Blue)", "As It Was", "Dont You Worry", "SNAP", "Mood", "Super Freaky Girl", "Ferrari", "Seize the Power", "B.O.T.A. (Baddest Of Them All)", "Quevedo: Bzrp Music Sessions, Vol. 52", "BILLIE EILISH.", "Hold Me Closer", "KU LO SA - A COLORS SHOW", "Calm Down", "Mary On A Cross", "Last Last", "Hold My Hand", "Glimpse of Us", "Bones", "Another Love", "Afraid To Feel", "Running Up That Hill (A Deal With God)", "DESPECHÁ", "Late Night Talking", "Bad Habit", "La Bachata", "Tití Me Preguntó", "Bandana", "Stay With Me", "Vegas (From the Original Motion Picture Soundtrack ELVIS)", "Bad Memories (feat. Elley Duhé & FAST BOY)", "Pepas", "Faded", "1, 2, 3 (feat. De La Ghetto & Jason Derulo)", "MIDDLE OF THE NIGHT", "About Damn Time", "I Like You (A Happier Song) [feat. Doja Cat]", "For My Hand (feat. Ed Sheeran)", "One Kiss", "Heat Waves", "Lonely", "Crazy Vibez", "SNAP (High and Fast)", "Doja", "Belly Dancer", "Numb"
    };
    string artistas[50] = {
        "Chris Brown", "JIN", "OneRepublic", "Rema", "David Guetta & Bebe Rexha", "Harry Styles", "Black Eyed Peas, Shakira & David Guetta", "Rosa Linn", "Makar", "Nicki Minaj", "James Hype & Miggy Dela Rosa", "Yonaka", "Eliza Rose & Interplanetary Criminal", "Bizarrap & Quevedo", "Armani White", "Elton John & Britney Spears", "Oxlade", "Rema & Selena Gomez", "Ghost", "Burna Boy", "Lady Gaga", "Joji", "Imagine Dragons", "Tom Odell", "LF SYSTEM", "Kate Bush", "ROSALÍA", "Harry Styles", "Steve Lacy", "Manuel Turizo", "Bad Bunny", "Fireboy DML & Asake", "Justin Timberlake, Pharrell Williams, Halsey & Calvin Harris", "Doja Cat", "Meduza & James Carter", "Farruko", "Alan Walker", "Sofía Reyes", "Elley Duhé", "Lizzo", "Post Malone", "Burna Boy", "Calvin Harris & Dua Lipa", "Glass Animals", "Akon", "Luxury SA", "Rosa Linn", "Central Cee", "Imanbek & BYOR", "Marshmello & Khalid"
    };
    string autor[50] = {};
    string mp3[50] = {};
    int ranking[50] = {};
